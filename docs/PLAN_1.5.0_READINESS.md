...
| B8 | Plan P1/P2 items not started for 1.5.0: WS-DEPS-MAJORS (picky-krb 0.9→0.12, ~300 edits), WS-ADVISORY-CLEANUP (rsa 0.9 removal path), WS-CLI-SHRINK, WS-FUZZ-DEEP (7 nights green), WS-RECEIPT-SCHEMA + WS-CASCADE-REHEARSAL, WS-MSRV-POLICY, WS-LDAPS-CB-INVESTIGATE | maintainer decision on scope-cut vs 1.5.0-alpha1 vs defer to 1.5.1 | 1.5.0-beta / 1.5.0-rc |
