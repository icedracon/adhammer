...
> in HTML/MD/terminal — commit `7058c53`). WS-COVERAGE **in progress: registry 41 → 56** (+15,
> latest: ForeignPrincipalInPrivGroup, ComputerInPrivGroup, ConstrainedToDc [Critical], WeakCertTemplateCrypto) (formerly +11
